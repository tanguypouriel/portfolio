...
export default function AboutMeSection({ className }: AboutMeProps) {
    return (
        <section className={`h-screen flex flex-col items-center p-6 ${className}`}>
            ...
            <div className="w-full h-2/3 flex flex-col-reverse md:flex-row items-center p-8">
                <div className='flex-[5_5_0%] flex flex-col items-center '>
                    <div className='flex flex-col gap-4'>
                        <h2 className="text-8xl font-bold text-indigo-50">Tanguy Pouriel</h2>
                        <h2 className="text-xl font-bold text-teal-100 mx-8">Fullstack Mobile developer</h2>
            ...
            <p className="text-center text-2xl px-8 text-justify mx-8">
