...
export default function ContactSection() {
    return (
        <section className="flex flex-col items-center gap-4 w-full bg-indigo-50 p-6 md:p-16 pb-[120px] md:pb-[200px] text-gray-900">
            <h1 className="text-2xl md:text-4xl font-bold md:mx-16 pb-6">Get in touch</h1>
